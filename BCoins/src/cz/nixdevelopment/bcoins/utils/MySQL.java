...
public class MySQL {
    ...
    public static void createTable() {
        ...
        try {
            ...
            PreparedStatement statement = BCoins.getConnection().prepareStatement("CREATE TABLE IF NOT EXISTS BCoins(UUID varchar(36) PRIMARY KEY, Nick varchar(16), Wallet double)");
    ...
    public static boolean setTokens(String UUID, double toSet) {
        ...
        try {
            PreparedStatement statement = BCoins.getConnection()
                    .prepareStatement("UPDATE BCoins SET Wallet=? WHERE UUID=?");
